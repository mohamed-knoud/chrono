...
/><br/>
      ...
      <input autocomplete="off" value={formData.lastName} onChange={handleChange2} type="text" placeholder='last name' style={{width:'45%',height:'50px',margin:'15px 0px 0px 20px'}} id="lastName" name="lastName"/>
