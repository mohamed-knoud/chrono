...
upsd.current.style.display='none'
  ...
  {edit && <div id="edit">
      ...
      <input autocomplete="off" value={formData.lastName} onChange={handleChange2} type="text" id="lastName" placeholder='last name' style={{width:'45%',height:'50px',margin:'15px 0px 0px 20px'}} name="lastName"/>
